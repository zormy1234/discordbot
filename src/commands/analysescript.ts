import {
  ...
  async function analyzeDay(day: string) {
    ...
    let pending: ScaleEvent | null = null;
    ...
    return {
      ...
      delayedUps,
      delayedDowns,
      delayedSlower: events.filter(
        e => e.delayedTime && e.delayedTime - e.immediateTime > ONE_MINUTE
      )
    };
  }
