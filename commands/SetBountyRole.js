...
async function setBountySetterRole(guildId, role) {
    await connection.execute(`INSERT INTO bounty_config (guild_id, bounty_role_id)
       VALUES (?, ?)
       ON DUPLICATE KEY UPDATE bounty_role_id = VALUES(bounty_role_id)`, [guildId, role.id]);
}
